...
def main(
    *,
    ...
    model_weights = torchvision.models.DenseNet121_Weights.DEFAULT
    ...
    model = torchvision.models.densenet121(weights=model_weights, progress=True)
    ...
    logging.info(f"Model classifier architecture is {model.classifier}")
