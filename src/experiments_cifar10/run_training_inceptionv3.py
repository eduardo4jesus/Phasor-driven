...
def main(
    *,
    ...
    model_name="InceptionV3_CIFAR10",
    timestamp: str = "",
):
    # Output paths
    ...
    model = torchvision.models.inception_v3(progress=True)
    ...
    logging.info(f"Model modified architecture is {model.fc}")
    ...
    print(f"File saved: {log_path_csv}")
    logging.shutdown()
